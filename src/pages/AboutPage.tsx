      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
        ...
        <div className="md:col-span-8 space-y-8 text-brand-muted leading-relaxed font-sans">
          ...
          <div className="bg-brand-surface border border-brand-border p-10 relative">
            ...
            {/* Wider paragraph area */}
            <div className="pr-4">
              <p className="text-base leading-8 text-justify max-w-none">
                {sub_text}
              </p>
            </div>
          </div>
        ...
        <div className="md:col-span-4 space-y-10">
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="w-44 h-44 overflow-hidden border-2 border-brand-border bg-brand-surface shadow-xl">
              <img
                src="/Namelogo.png"
                alt="Profile"
            ...
            <div className="text-center px-2">
              <h3 className="font-mono text-sm text-brand-text uppercase tracking-widest">
                SWAYAM
              </h3>
          ...
          <div className="space-y-4">
            <h4 className="font-mono text-[9px] text-brand-accent uppercase tracking-widest">
              MAIN
            </h4>
